<template>
    <span class=" m-2 lg:m-7 xl:m-14 flex flex-col justify-center md:items-start items-center ">
        <h1 class="text-2xl text-center md:text-left md:text-3xl xl:text-5xl font-normal">
